...
import com.globizs.edulooker.datamodal.DateData;
import com.globizs.edulooker.util.CalenderCaculator;
...
public class CalenderAdapter extends RecyclerView.Adapter<CalenderAdapter.CustomViewHolder> {
    ...
    public static String TAG= com.globizs.edulooker.adapter.CalenderAdapter.class.getSimpleName();
